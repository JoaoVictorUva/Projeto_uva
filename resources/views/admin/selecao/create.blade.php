                    ...
                    <form class="grid grid-cols-1 gap-4" action="{{ route('selecao.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                            <div>
                                ...
                                <input type="text" id="titulo" name="titulo" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 " placeholder="Titulo da Seleção" value="{{ old('titulo') }}">
                                @error('titulo')
                        ...
                        <div class="grid grid-cols-2 gap-4">
                                ...
                                <div class="mt-1 flex items-center">
                                    <input type="file" id="edital" name="edital"
                                        class="block w-full text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 
                                                ...
                                                hover:file:bg-indigo-100 focus:file:bg-indigo-200" value="{{ old('edital') }}">
                            ...
                            <div>
                                ...
                                <input type="text" id="informacoes_gerais" name="informacoes_gerais" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 " value="{{ old('informacoes_gerais') }}">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="date" id="inscricao_inicio" name="inscricao_inicio" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 " value="{{ old('inscricao_inicio') }}">
                            ...
                            <div>
                                ...
                                <input type="date" id="inscricao_fim" name="inscricao_fim" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 " value="{{ old('inscricao_fim') }}">
                                @error('inscricao_fim')
                                    <div class="text-red-600 text-sm">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select id="exibir_edital" name="exibir_edital" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" value="{{ old('exibir_edital') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="exibir_resultado_inscricao" name="exibir_resultado_inscricao" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" value="{{ old('exibir_resultado_inscricao') }}">
                                <option value="1">Sim</option>
                                <option value="0">Não</option>
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <select id="finalizado" name="finalizado" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" value="{{ old('finalizado') }}">
                                <option value="1">Sim</option>
                                <option value="0">Não</option>
                            </select>
                            @error('finalizado')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="resultado" name="resultado" rows="4" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('resultado') }}</textarea>
                            @error('resultado')
                                <div class="text-red-600 text-sm">{{ $message }}</div>
                            @enderror
                        </div>
