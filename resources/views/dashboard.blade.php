    ...
    <div class="py-12 metrics-container flex flex-col font-nunito font-extrabold text-black dark:text-gray-200 max-w-6xl mx-auto mt-12">
        <div class="metrics-row flex flex-wrap gap-8 items-start justify-start w-full px-0">
            <div class="metric-card bg-white dark:bg-gray-800 rounded-3xl shadow-2xl flex flex-col justify-start flex-1 min-w-[240px] min-h-[250px] p-8 border border-gray-200">
                ...
                <button class="border border-green-500 bg-green-500 text-white py-2 px-4 rounded m-1 mt-4 w-full">Candidatos</button>
            </div>
            <div class="metric-card bg-white dark:bg-gray-800 rounded-3xl shadow-2xl flex flex-col justify-start flex-1 min-w-[240px] min-h-[250px] p-8 border border-gray-200">
                ...
                <button class="border border-green-500 bg-green-500 text-white py-2 px-4 rounded m-1 mt-4 w-full">Inscrições</button>
            </div>
            <div class="metric-card bg-white dark:bg-gray-800 rounded-3xl shadow-2xl flex flex-col justify-start flex-1 min-w-[240px] min-h-[250px] p-8 border border-gray-200">
                ...
                <button class="border border-green-500 bg-green-500 text-white py-2 px-4 rounded m-1 mt-4 w-full">Vagas</button>
            </div>
            <div class="metric-card bg-white dark:bg-gray-800 rounded-3xl shadow-2xl flex flex-col justify-start flex-1 min-w-[240px] min-h-[250px] p-8 border border-gray-200">
                ...
                <button class="border border-green-500 bg-green-500 text-white py-2 px-4 rounded m-1 mt-4 w-full">Seleções</button>
            </div>
        </div>
    </div>
</x-app-layout>
